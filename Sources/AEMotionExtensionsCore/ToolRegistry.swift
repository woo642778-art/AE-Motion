...
public enum ToolRegistry {
    public static let all: [ToolDescriptor] = [
        ...
        .init(id: "preset.library", title: "Preset Studio", subtitle: "Create, edit, validate, import, export and apply XML presets", section: .presets),
        .init(id: "resource.hub", title: "Font & Editing Resource Hub", subtitle: "DaFont, Keyfla.me resources and license-aware external links", section: .utilities),
